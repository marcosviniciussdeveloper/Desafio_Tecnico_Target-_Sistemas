...
{
    // Nesta classe, temos dois métodos estáticos que retornam strings JSON representando dados de vendas e estoque.
    public static class JsonSource
    {
        public static string GetSalesJson()
        {
            return @"
            {
              ""vendas"": [
        ...
        //Usei este JSON para representar um inventário de produtos com seus códigos, descrições e quantidades em estoque.
